      ...
      <div className='pt-1 flex pr-6 justify-center'>
        <div className='col-8 w-4/4'>
          <h1 className='ml-6 font-bold text-2xl md:text-3xl text-center'>
            Service selection according to your wishes:<br/>
            <span className='text-orange text-center'>Discover our craftsman categories and receive free craftsman offers</span> 
          </h1>
        </div>
      </div>
      <AllServices />
