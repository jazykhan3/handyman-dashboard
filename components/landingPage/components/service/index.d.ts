...
type SetStringStateAction = React.Dispatch<React.SetStateAction<ActionTypeString>>;
type Page1DataType = {
...
type LocationOfJobPage = {
    ...
    setLocationNamePage: SetStringStateAction;
    location_namePage: ActionTypeString
}
...
type ContactDetailsPropsTypePag = {
    setContactDetailsPage: React.Dispatch<React.SetStateAction<ContactDetailsPage6DataType>>;
