...
export default function AcceptedOfferCS({job_title,listing_ID,price,posted_on,status}:{ job_title: string;listing_ID: string;price: string;posted_on: {date: string;time: string;};status:string}) {
  return (
      ...
      <div className="px-10 py-5">
        ...
        <div className="py-1">
          ...
          <Link href={'/dashboard/admin/reviewsectioncs'}>
            <button className=" bg-orange hover:text-black text-white font-bold py-2 px-4 rounded-lg focus:outline-none mt-4">Edi Review</button>
          </Link>
        </div>
      </div>
    </div>
