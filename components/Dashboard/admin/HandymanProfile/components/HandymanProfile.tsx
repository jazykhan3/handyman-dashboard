      ...
      <div>
        <div className="lg:w-3/4 lg:mx-auto">
          <div className="flex justify-center items-center bg-[#F0EAEA] py-3 px-10 rounded-t-md">
            <span className="font-bold w-[30rem]">Address</span>
            <span className="font-bold w-[30rem]">Address</span>
            <span className="font-bold w-[9rem]">Email Address</span>
          </div>
          {TestData.map((item) => (
        ...
        <div className="lg:w-3/4 lg:mx-auto">
          <div className="flex justify-center items-center bg-[#F0EAEA] py-3 px-10">
            <span className="font-bold w-[30rem]">Surname</span>
            <span className="font-bold w-[30rem]">Last Name</span>
            <span className="font-bold w-[9rem] border-2">Company Name</span>
          </div>
          {TestData.map((item) => (
            <Table key={item.id} col1={item.IP_Address} col2={item.Login_Date} col3={item.Login_Time} width={9}/>
          ))}
