      ...
      <div className="w-full overflow-x-scroll">
        <div className="flex justify-center items-center  bg-[#F0EAEA] px-8 py-4 w-[60rem] md:w-full">
          <div className="flex justify-start items-center w-[20rem] gap-2">
            ...
            <span className="ml-2 font-bold">Job Title</span>
          </div>
          <span className="font-bold w-[20rem]">Listing ID</span>
          <span className="font-bold w-[20rem]">Date of Post</span>
          <span className="font-bold w-[7rem]">Actions</span>
        </div>
        <div className=" bg-white rounded-b-md w-[60rem] md:w-full">
          {tabelData.length !== 0 ? (
            ...
            <div className="py-3 text-center w-full">
              <span>You do not have any job posts.</span>
            </div>
          )}
        </div>
      </div>
