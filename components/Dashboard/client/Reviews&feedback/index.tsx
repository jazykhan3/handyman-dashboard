...
const ReviewsSection = ({paragraph,star}:{paragraph:string;star:Number[]}) => {
  return (
    ...
    <div className="w-full  bg-white rounded-lg shadow my-4 ">
              <section className="flex items-center justify-between p-2"><div className="p-4 flex items-center gap-3">
  ...
  return (
    <div className="my-2 w-full md:mx-32">
      <h1 className="text-3xl font-bold">
        <span className="text-orange">Real Opinions:</span> Discover customer ratings and feedback
      </h1>
