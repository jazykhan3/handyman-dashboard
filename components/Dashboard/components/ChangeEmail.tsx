      ...
      <div className="w-full">
        <div className="flex justify-center items-center gap-2 lg:gap-5 w-full lg:flex-row flex-col">
          <div className="mb-5 w-full lg:w-1/2 relative">
            ...
            <input id="newEmail" type="email" className="w-full px-3 py-3 border border-gray-600 rounded outline-none" value={userEmail.email} onChange={e=>setUserEmail(pre=>({...pre,email:e.target.value}))} placeholder="Enter your email" required/>
          ...
          <div className="mb-5 w-full lg:w-1/2 relative">
            ...
            <input id="confirmEmail" type="email" className="w-full px-3 py-3 border border-gray-600 rounded outline-none" value={userEmail.cEmail}  onChange={e=>setUserEmail(pre=>({...pre,cEmail:e.target.value}))} placeholder="Enter your email" required/>
